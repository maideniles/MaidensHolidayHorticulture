...
public class ModPlacements {
 ...
 //   public static final PlacedFeature FLOWERING_LILYPAD = PlacementUtils.register("lily_pad_placement", ModFeatures.LILY_PAD_CONFIG.placed(worldSurfaceSquaredWithCount(4)));
    ...
    public static final PlacedFeature YEW_PLACEMENT = PlacementUtils.register("yew_placement", ModFeatures.YEW_CONFIG.placed(PlacementUtils.countExtra(0, 0.25F, 1), InSquarePlacement.spread(),VegetationPlacements.TREE_THRESHOLD, PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, BlockPredicateFilter.forPredicate(BlockPredicate.wouldSurvive(Blocks.OAK_SAPLING.defaultBlockState(), BlockPos.ZERO)), BiomeFilter.biome()));
