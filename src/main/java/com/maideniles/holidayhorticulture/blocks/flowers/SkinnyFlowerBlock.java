...
public class SkinnyFlowerBlock extends BushBlock {

    protected static final VoxelShape SHAPE = Block.box(5.0D, 0.0D, 5.0D, 11.0D, 18.0D, 11.0D);

    public SkinnyFlowerBlock(Properties p_51021_) {
        super(p_51021_);
    }
